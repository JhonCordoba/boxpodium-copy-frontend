                ...
                <div className="flex flex-col items-center">
                    <div className="relative flex flex-col items-center justify-center px-4 md:px-[95px] py-2 md:py-[10px]">
                        <div className="text-center justify-center">
                            <h1 className="text-white text-[40px] md:text-[72px] leading-[48px] md:leading-[89px]">
                                Del <span className="text-[#FFBD00] relative inline-block" style={{ fontFamily: 'Bebas Neue' }}>
                                    WOD
                    ...
                    <div className="flex justify-center items-center">
                        <div className="max-w-[95vw] w-full md:w-[603px] text-center text-white text-base md:text-[20px] font-axiforma font-normal leading-[24px] md:leading-[31px]">
                            <span>Organiza, visualiza y comparte los resultados de tus eventos de CrossFit en tiempo real, fácil, rápido e intuitivo.</span>
                        </div>
                    </div>
                </div>
            </div>
